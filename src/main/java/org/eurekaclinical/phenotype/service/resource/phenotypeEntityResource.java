 ...
 */
@Transactional
@Path("/protected/phenotypeEntity")
@RolesAllowed({"admin"})
@Consumes(MediaType.APPLICATION_JSON)
public class phenotypeEntityResource {
    
	private static final Logger LOGGER
			= LoggerFactory.getLogger(phenotypeEntityResource.class);
	...
	@Inject
	public phenotypeEntityResource(PhenotypeEntityDao inDao, AuthorizedUserDao inUserDao,
	...
	public List<PhenotypeEntity> getAllToProp(@Context HttpServletRequest inRequest) {
